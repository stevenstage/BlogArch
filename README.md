...
**🧠 探索 Foundation Model 在电力电子领域的无限可能**  
*论文精读 · 研究进展 · 前沿 Idea*

[📖 快速浏览](#内容介绍) · [🔬 研究进展](#研究进展) · [📊 成果展示](#成果) · [🤝 参与贡献](#如何贡献)
...
本仓库系统梳理 **Foundation Model 在电力电子（Power Electronics）领域的应用与研究**，涵盖：

- 🔧 **论文精读**：深度解析时序建模、大语言模型、稀疏注意力等关键技术
- 🧠 **研究进展**：预训练模型迁移、学习动力学等前沿探索  
- 🚀 **Idea 生成**：跨领域创新思路与实验洞察

> 💡 **持续更新中**，欢迎通过 Issue 或 PR 分享你的建议与新视角！
...
| 文章 | 核心看点 | 标签 |
|:---|:---|:---|
| [PFML: Self-supervised Learning of Time-series Data without Representation Collapse](https://blog.csdn.net/ldy_lzy/article/details/145065042) | 解决自监督时序学习中的表征坍缩问题 | `自监督` `时序` |
| [DeepSeek LLM: Scaling Open-Source Language Models with Longtermism](https://blog.csdn.net/ldy_lzy/article/details/145518503) | 开源大模型的长程 scaling 策略 | `LLM` `Scaling` |
| [DeepSeek-V2: A Strong, Economical, and Efficient Mixture-of-Experts Language Model](https://blog.csdn.net/ldy_lzy/article/details/145659517) | MoE 架构的高效训练与推理 | `MoE` `高效推理` |
...
| 文章/论文 | 核心贡献 | 标签 |
|:---|:---|:---|
| [Data-Efficient Motor Condition Monitoring with Time Series Foundation Models](https://arxiv.org/abs/2511.23177) | 将 Foundation Model 应用于电机故障诊断，实现数据高效监测 | `故障诊断` `电机` `时序FM` |
